...
<center>
<img align="left" img width="24%" src="data/tinderesting_images/0045.png"/>
<img align="left" img width="24%" src="data/tinderesting_images/0050.png"/>
<img align="right" img width="24%" src="data/tinderesting_images/0003.png"/>
<img align="right" img width="24%" src="data/tinderesting_images/0039.png"/>
</center>
...
* review half of the images with tinderesting (the training dataset, images need to be in the **data/tinderesting_images** folder),
...
Put the images to be used in tinderesting in the **data/tinderesting_images** folder.
...
```{r res, dpi = 400, fig.width = 4, fig.height = 4}
